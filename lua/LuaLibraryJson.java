...
enum LuaLibraryJson implements BiConsumer<Environment, LuaObject>, LuaMethod
{
	read() {
		@Override
	...
	private static JsonValue toJson(LuaObject obj)
	{
		...
		else if(obj.isTable())
		{
			...
			else
			{
				...
				for(LuaObject indx : obj.getIndicies())
					o.put(indx.getString(), toJson(obj.getIndex(indx)));
	...
	private static LuaObject toLua(JsonValue val)
	{
