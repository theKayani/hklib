...
do
  ...
  print(intbits .. "-bit integers, " .. floatbits .. "-bit (mantissa) floats")
end
...
if floatbits < intbits then
  ...
  --[[
  --I don't know why Lua 5.3 needs this to not work
  --################################################################################
...
-- assert(maxint < minint * -1.0) -- THIS CAN'T BE TRUE IN JAVA BECAUSE abs(Long.MAX_VALUE) < abs(Long.MIN_VALUE)
assert(maxint <= minint * -1.0) -- THIS CAN                     BECAUSE abs(Long.MAX_VALUE) < abs(Long.MIN_VALUE)

do
  -- BECAUSE abs(Long.MAX_VALUE) < abs(Long.MIN_VALUE)
